...
package com.ryan.ryanjpctar.cardboard;
...
public abstract class VRRenderer extends Renderer implements CardboardView.StereoRenderer {
    ...
    public void onSurfaceChanged(int width, int height) {
        ...
        Logger.d("VRRenderer: onSurfaceChanged");
    }

    @Override
    public void onSurfaceCreated(EGLConfig eglConfig) {
        super.onRenderSurfaceCreated(eglConfig, null, -1, -1);
        Logger.d("VRRenderer: onSurfaceCreated");
    }

    @Override
    public void onRenderSurfaceCreated(EGLConfig config, GL10 gl, int width, int height) {
        super.onRenderSurfaceCreated(config, gl, width, height);
        Logger.d("VRRenderer: onRenderSurfaceCreated");
    }

    @Override
    public void onRenderSurfaceSizeChanged(GL10 gl, int width, int height) {
        super.onRenderSurfaceSizeChanged(gl, width, height);
        Logger.d("VRRenderer: onRenderSurfaceSizeChanged");
    }
